...
def generate_vocabulary_save_embeddings(lowF, txtfile, w_dict, v_matrix, save_p):
    ...
    with open(os.path.join(save_p, 'save_initializaton_embeddings_%d_%d.pickle' % (final_w_size, final_cha_size)),
              'wb') as f:
...
if __name__ == '__main__':
    ...
    generate_vocabulary_save_embeddings(3, input_text, input_embedding_Word_dict, input_embedding_Vector_matrix,
                                        save_path)
